...
public class EulerCalculator2 {
    ...
    public static void calculateAndLog(int k, int numberOfThreads, BiFunction<Integer, Integer, BigDecimal> calculator) throws Exception {
        ...
        System.out.println(String.format("k: %d, threads: %d, duration: %d ms", k, numberOfThreads, duration));
//		System.gc();
    }
...
//    		calculateAndLog(30000, idx, first.EulerCalculator::calculate);
            calculateAndLog(10000, 1, EulerCalculator2::calculate);
            calculateAndLog(10000, 2, EulerCalculator2::calculate);
            calculateAndLog(10000, 4, EulerCalculator2::calculate);
            calculateAndLog(10000, 6, EulerCalculator2::calculate);
            calculateAndLog(10000, 8, EulerCalculator2::calculate);
            System.out.println();
        }
    }
}
